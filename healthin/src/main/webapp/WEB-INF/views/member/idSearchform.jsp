...
<body>
	...
	<div id="daumWrap">
			...
			<div id="cMain">
				<div id="mArticle">
											...
											<div class="desc_involve">
												...
												<div class="box_detail">
													<div class="bg_find bg_nation">
														<div class="bg_find inner_bg">
															<strong class="screen_out">국가번호 선택 상자</strong> <span
																class="screen_out">선택내용 : </span> <a href="javascript:;"
																class="link_nationnum"></a>
															<div class="wrap_nationinfo">
																<div class="box_nationinfo">
																	<span class="ico_find"></span> <label
																		for="inpNationInfo" class="txt_placeholder">국가
																		검색(국가번호, 국가명)</label> <input id="inpNationInfo" type="text"
																		class="inp_nationinfo" autocomplete="off">
																</div>
					...
					<ul class="list_method">
						<li>비밀번호를 찾으시나요?<a
							href="${pageContext.request.contextPath}/passwordSearchform.do"
							class="link_tip">비밀번호 찾기</a> <span class="ico_find ico_more"></span>
						</li>
					</ul>
				</div>
				<!--// mArticle -->
		...
		<div id="daumFoot" class="footer_comm" role="contentinfo">
			...
			<a href="http://policy.daum.net/info/info" class="link_info"
				target="_blank">서비스 약관/정책</a> | <a
				href="http://policy.daum.net/info_protection/info_protection"
				class="link_info" target="_blank">개인정보처리방침</a> | <a
				href="https://cs.daum.net/redbell/top.html" class="link_info"
				target="_blank">권리침해신고</a> | <a
				href="http://cs.daum.net/faq/59.html" target="_blank"
				class="link_info">고객센터</a>
			<address class="txt_copyright">
				Copyright &#169; <a href="http://www.kakaocorp.com"
					class="link_daum" style="font-weight: bold">OgigeMapGo Corp.</a>
				All rights reserved.
			</address>
		</div>
		<script type="text/javascript">
	...
	<link rel="stylesheet"
		href="/content/jquery/jquery-ui-1.10.4.custom.css">
	<script type="text/javascript"
		src="/content/jquery/jquery-ui-1.10.4.custom.js">
