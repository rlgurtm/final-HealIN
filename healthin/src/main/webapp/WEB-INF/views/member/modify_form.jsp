								...
								<dd>
									<div class="wrap_inp">
										...
										<input type="text" id="name" name="name" class="inp_info"
											value="${sessionScope.mvo.name }" maxlength="30"
											readonly="readonly"> <span class="mark_valid"><span
								...
								<dd>
									<div class="wrap_inp">
										...
										<input type="text" id="birthdate" name="birthdate"
											...
											maxlength="30" readonly="readonly"> <span
									...
									<c:choose>
										<c:when test="${sessionScope.mvo.gender == female }">
											<input type="radio" name="gender" value="female"
												checked="checked" readonly="readonly">여자 &nbsp;&nbsp;  </c:when>
										<c:otherwise>
											<input type="radio" name="gender" value="male"
												checked="checked" readonly="readonly">남자
										</c:otherwise>
									</c:choose>
									<p class="txt_message" style="display: none;"></p>
								</dd>
