...
<div class="container">
	...
	<c:choose>
		...
		<input type="button" id="test" value="평가하기">
				...
				<div class="modal-content">
					...
					<div class="modal-body" align="left">
						<form id="inputTypeForm" action="${pageContext.request.contextPath}/calorieType.do">
							...
							<!-- <div>
								<input class="hover-star" type="radio" name="test-3B-rating-1" value="1" />
								<input class="hover-star" type="radio" name="test-3B-rating-2" value="2" />
								<input class="hover-star" type="radio" name="test-3B-rating-2" value="3" />
							</div> -->
