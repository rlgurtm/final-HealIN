...
public class PagingBeanForRating extends PagingBean {
	// 현재 페이지
	 ...
	 * @param totalContents
	 */
	public PagingBeanForRating(int totalContents) {
	 ...
	 * @param nowPage
	 */
	public PagingBeanForRating(int totalContents, int nowPage) {
		this.totalContents = totalContents;
